...
/*   Updated: 2023/12/18 18:24:49 by dhadding         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// INIT3_C ///
t_v32	init_camera(t_program *program);
t_v32	init_light(t_program *program);
t_v32	init_amb_light(t_program *program);

/// INIT4_C ///
t_v32	view_init(t_program *program);

/// KEYPRESS1_C ///
t_s32	keypress(int keycode, t_v32 *param);
...
/// WINDOW1_C ///
t_v32	*create_window(t_s8 *title, t_program *program);
